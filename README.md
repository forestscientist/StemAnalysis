...
[![Travis build
status](https://travis-ci.com/forestscientist/StemAnalysis.svg?branch=main)](https://travis-ci.com/forestscientist/StemAnalysis)
<!-- badges: end -->

The goal of StemAnalysis is to …

## Installation

You can install the development version of StemAnalysis like so:
