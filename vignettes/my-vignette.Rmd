...
```{r, eval=FALSE}
require(StemAnalysis)
require(knitr) # To input figures in this document
```
...
```{r, eval=FALSE, cache=TRUE}
stemgrowth <- stemanalysism(xtree = 8, treecarbon = TRUE, stemdata = stemdata, BEFdata = BEFdata)
```
